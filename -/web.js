...
(function ($) {
    class $bw_icon_slide_left extends $.$mol_svg_root {
        ...
        Path() {
            return ((obj) => {
                obj.geometry = () => "M17.5 6A1.5 1.5 0 0 0 16 7.5 1.5 1.5 0 0 0 17.5 9 1.5 1.5 0 0 0 19 7.5 1.5 1.5 0 0 0 17.5 6zm6 0A1.5 1.5 0 0 0 22 7.5 1.5 1.5 0 0 0 23.5 9 1.5 1.5 0 0 0 25 7.5 1.5 1.5 0 0 0 23.5 6zm-6 7a1.5 1.5 0 0 0-1.5 1.5 1.5 1.5 0 0 0 1.5 1.5 1.5 1.5 0 0 0 1.5-1.5 1.5 1.5 0 0 0-1.5-1.6zm6 0a1.5 1.5 0 0 0-1.5 1.5 1.5 1.5 0 0 0 1.5 1.5 1.5 1.5 0 0 0 1.5-1.5 1.5 1.5 0 0 0-1.5-1.6zm-.8 6L17 27l5.7 8 1.3-.9-5-7.1 5-7.1-1.3-.9zm-5.2 19a1.5 1.5 0 0 0-1.5 1.5 1.5 1.5 0 0 0 1.5 1.6 1.5 1.5 0 0 0 1.5-1.6 1.5 1.5 0 0 0-1.5-1.5zm6 0a1.5 1.5 0 0 0-1.5 1.5 1.5 1.5 0 0 0 1.5 1.6 1.5 1.5 0 0 0 1.5-1.6 1.5 1.5 0 0 0-1.5-1.5zm-6 7a1.5 1.5 0 0 0-1.5 1.5 1.5 1.5 0 0 0 1.5 1.5 1.5 1.5 0 0 0 1.5-1.5 1.5 1.5 0 0 0-1.5-1.5zm6 0a1.5 1.5 0 0 0-1.5 1.5 1.5 1.5 0 0 0 1.5 1.5 1.5 1.5 0 0 0 1.5-1.5 1.5 1.5 0 0 0-1.5-1.5z";
                return obj;
            })(new this.$.$mol_svg_path);
        }
    }
...
(function ($) {
    class $bw_icon_slide_right extends $.$mol_svg_root {
        ...
        Path() {
            return ((obj) => {
                obj.geometry = () => "M23.5 48a1.5 1.5 0 0 0 1.5-1.5 1.5 1.5 0 0 0-1.5-1.5 1.5 1.5 0 0 0-1.5 1.5 1.5 1.5 0 0 0 1.5 1.5zm-6 0a1.5 1.5 0 0 0 1.5-1.5 1.5 1.5 0 0 0-1.5-1.5 1.5 1.5 0 0 0-1.5 1.5 1.5 1.5 0 0 0 1.5 1.5zm6-7a1.5 1.5 0 0 0 1.5-1.5 1.5 1.5 0 0 0-1.5-1.5 1.5 1.5 0 0 0-1.5 1.5 1.5 1.5 0 0 0 1.5 1.6zm-6 0a1.5 1.5 0 0 0 1.5-1.5 1.5 1.5 0 0 0-1.5-1.5 1.5 1.5 0 0 0-1.5 1.5 1.5 1.5 0 0 0 1.5 1.6zm.8-6l5.7-8-5.7-8-1.3.9 5 7.1-5 7.1 1.3.9zm5.2-19a1.5 1.5 0 0 0 1.5-1.5 1.5 1.5 0 0 0-1.5-1.6 1.5 1.5 0 0 0-1.5 1.6 1.5 1.5 0 0 0 1.5 1.5zm-6 0a1.5 1.5 0 0 0 1.5-1.5 1.5 1.5 0 0 0-1.5-1.6 1.5 1.5 0 0 0-1.5 1.6 1.5 1.5 0 0 0 1.5 1.5zm6-7A1.5 1.5 0 0 0 25 7.5 1.5 1.5 0 0 0 23.5 6 1.5 1.5 0 0 0 22 7.5 1.5 1.5 0 0 0 23.5 9zm-6 0A1.5 1.5 0 0 0 19 7.5 1.5 1.5 0 0 0 17.5 6 1.5 1.5 0 0 0 16 7.5 1.5 1.5 0 0 0 17.5 9z";
                return obj;
            })(new this.$.$mol_svg_path);
        }
    }
                            ...
                            setTimeout(() => {
                                if (this._rec_fld_request_by_guid) {
                                    this.request_data_worker({ cmd: 'recs', by_guid: this._rec_fld_request_by_guid }, (event) => {
                                        ...
                                        if (event.data.status == 'ok') {
                                            console.log({ '': 'by_guid', brutto: Date.now() - start, netto: event.data.timing, count: event.data.by_guid.size });
                                    ...
                                    this.request_data_worker({ cmd: 'recs', by_idx: this._rec_fld_request_by_idx }, (event) => {
                                        this._rec_fld_waiting = false;
                                        if (event.data.status == 'ok') {
                                            console.log({ '': 'by_idx', brutto: Date.now() - start, netto: event.data.timing, count: event.data.by_idx.size });
